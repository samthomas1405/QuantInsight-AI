            ...
            {!success && (
              <form onSubmit={handleRegister} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative mt-1">
                    <Input
                      ...
                      className="block w-full px-4 py-3 pr-12 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                      required
                    />
                    <button
                      type="button"
                ...
                <motion.button
                  ...
                  className="w-full bg-indigo-600 text-white font-semibold py-3 px-4 rounded-lg hover:bg-indigo-700 transition-all duration-200 flex items-center justify-center space-x-2 disabled:opacity-70 disabled:cursor-not-allowed shadow-sm"
                >
                  {loading ? (
                    <>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-600 to-purple-700 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 mt-12">
          <svg viewBox="0 0 400 200" className="w-full max-w-md mx-auto">
            ...
            {/* Animated Bars */}
            {[
              { x: 40, height: 140, delay: 0 },
              { x: 120, height: 100, delay: 0.1 },
              { x: 200, height: 120, delay: 0.2 },
              { x: 280, height: 80, delay: 0.3 },
              { x: 360, height: 130, delay: 0.4 }
            ].map((bar, index) => (
              <motion.rect
                key={index}
                x={bar.x}
                ...
                animate={{ height: bar.height, y: 160 - bar.height }}
        ...
        <div className="relative z-10 space-y-6 mt-16">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Bank-level security to protect your data and investments</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-indigo-100 text-sm">Real-time data processing and instant insights</p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h3 className="font-semibold text-white mb-1">Data-Driven</h3>
              <p className="text-indigo-100 text-sm">Advanced analytics powered by machine learning</p>
            </div>
          </div>
        </div>
      </div>
